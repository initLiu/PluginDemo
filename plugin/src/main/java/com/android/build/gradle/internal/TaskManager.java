...
//            TestLog.log("TaskManager","createProcessResTask "+element.getFileName());
//            TestLog.log("TaskManager","createProcessResTask "+element.getClassName());
//            TestLog.log("TaskManager","createProcessResTask "+element.getMethodName());
//            TestLog.log("TaskManager","createProcessResTask "+element.getLineNumber());
//        }
//        TestLog.log("TaskManager", "createProcessResTask symbolLocation=" + symbolLocation.getAbsolutePath());
        BaseVariantData<? extends BaseVariantOutputData> variantData = scope.getVariantData();
