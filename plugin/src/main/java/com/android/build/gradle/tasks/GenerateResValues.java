...
import com.test.plugin.TestLog;
...
public class GenerateResValues extends BaseTask {
    ...
    private StringWriter mDebugOutput = new StringWriter(8 * 1024);
    private PrintWriter mDebugPrinter = new PrintWriter(mDebugOutput);
...
//        TestLog.log("Test","GenerateResValues setItems ");
//        StackTraceElement[] elements = new Throwable().getStackTrace();
//        for (StackTraceElement element : elements) {
//            TestLog.log("Test", "setItems " + element.getClassName());
//            TestLog.log("Test", "setItems " + element.getFileName());
//            TestLog.log("Test", "setItems " + element.getMethodName());
//            TestLog.log("Test", "setItems " + element.getLineNumber());
//        }
        this.items = items;
    }
...
//        TestLog.log("Test","GenerateResValues getItemValues ");
        List<Object> resolvedItems = getItems();
//        TestLog.log("Test", "GenerateResValues getItemValues resolvedItems.size=" + resolvedItems.size());
...
//        TestLog.log("Test", "GenerateResValues getItemValues list.size=" + list.size());
        return list;
    }
...
//            TestLog.log("Test","GenerateResValues$ConfigAction execure ");
