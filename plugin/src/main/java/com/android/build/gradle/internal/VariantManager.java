...
//        TestLog.log("Test","createTasksForVariantData variantData name="+variantData.getName());
        VariantType variantType = variantData.getType();
//        TestLog.log("Test","createTasksForVariantData variantType name="+variantType.name());
...
//        for (BaseVariantData data : variantDataList) {
//            this.project.getLogger().warn("************************variantData name=" + data.getName());
//        }
    }
