...
//        TestLog.log(TAG, "resourceSets=" + (resourceSets == null ? 0 : resourceSets.size()));
...
//        TestLog.log(TAG, "getConfiguredResourceSets resourceSets=" + resourceSets.size() + " generatedSets=" + generatedSets.size());
        for (ResourceSet resourceSet : resourceSets) {
//            TestLog.log(TAG, "resourceSet " + resourceSet.getLibraryName() + "," + resourceSet.getConfigName());
            resourceSet.setPreprocessor(preprocessor);
...
//        TestLog.log(TAG, "getInputResourceSets inputResourceSets=" + (inputResourceSets == null ? 0 : inputResourceSets.size()));
